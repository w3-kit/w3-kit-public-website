              ...
              {prices.map((token) => (
                <div
                  ...
                  className="flex-shrink-0 px-3 py-1.5 bg-muted rounded-full
                    flex items-center space-x-2 cursor-pointer hover:bg-muted/80
          ...
          <div className="bg-card divide-y divide-border">
            {prices.map((token) => (
              <div key={token.symbol} className="transition-colors duration-150">
                ...
                <div
                  className={`transition-all duration-300 ease-in-out overflow-hidden bg-muted/20 border-t border-border
                    ${
                      selectedToken === token.symbol
