...
function EcosystemCardItem({ icon, title, tagline, features, section, isCurrent }: EcosystemCard) {
  return (
    <div
      className="flex h-full flex-col gap-5 rounded-xl p-6 transition-all"
      style={{
        background: isCurrent ? "var(--w3-accent-subtle)" : "var(--w3-glass-bg)",
        border: isCurrent ? "1px solid var(--w3-accent)" : "1px solid var(--w3-glass-border)",
    ...
    >
      ...
      <div
        ...
        style={{
          background: isCurrent ? "var(--w3-accent)" : "var(--w3-accent-subtle)",
          color: isCurrent ? "#fff" : "var(--w3-accent)",
        }}
        aria-hidden="true"
      >
        {icon}
      ...
      <div className="mt-auto">
        <a
          ...
          className="group inline-flex items-center gap-1.5 text-xs font-medium transition-all"
    ...
    <SectionContainer className="py-20 md:py-32" id="ecosystem">
      <div ref={containerRef} className="flex flex-col gap-10">
        ...
        <div data-reveal className="flex flex-col gap-3">
          ...
          <p className="max-w-md text-base" style={{ color: "var(--w3-gray-600)" }}>
