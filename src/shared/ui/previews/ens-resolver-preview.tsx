          ...
          <div style={{ display: "flex", gap: 8 }}>
            <input
              ...
              style={{
                ...
                borderRadius: 10,
                border:
                  state === "error" ? "1px solid #ef4444" : "1px solid var(--w3-border-subtle)",
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 10,
                border: "none",
                background: query.trim() ? "var(--w3-accent)" : "var(--w3-gray-300)",
                color: "#fff",
                fontSize: 13,
                fontWeight: 600,
        ...
        <div style={{ padding: "20px" }}>
          ...
          >
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 16, fontWeight: 600, color: "var(--w3-gray-900)" }}>
                {result.ensName}
              </div>
            </div>
            <button
