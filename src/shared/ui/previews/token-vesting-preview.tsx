...
export function TokenVestingPreview() {
  useEffect(() => {
    preloadCryptoLogos(SCHEDULES.map((s) => s.ticker));
  }, []);
          ...
          return (
            <div
              ...
              style={{
                borderRadius: 12,
                overflow: "hidden",
                background: isExpanded ? "var(--w3-glass-inner-bg)" : "transparent",
              ...
              {isExpanded && (
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      <span
                        style={{ fontSize: 12, color: "var(--w3-gray-500)", fontFamily: monoFont }}
                      >
                      ...
                      <span
                        style={{ fontSize: 12, color: "var(--w3-gray-500)", fontFamily: monoFont }}
                      >
                        {fmt(s.total - s.vested)} remaining
                      </span>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      <div
                        style={{
                          height: "100%",
                          borderRadius: 3,
                          background: s.status === "completed" ? "#22c55e" : "var(--w3-accent)",
                          width: `${progress}%`,
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                    ...
                    <div
                      style={{
                        ...
                        border: effectiveClaimable > 0 ? "1px solid rgba(34,197,94,0.15)" : "none",
                      }}
                    >
                      <div
                        style={{
                      ...
                      <div
                        style={{
                          fontSize: 13,
                          fontWeight: 600,
                          color: effectiveClaimable > 0 ? "#22c55e" : "var(--w3-gray-900)",
                          fontFamily: monoFont,
                        }}
                      >
                        {fmt(effectiveClaimable)}
                      </div>
                    </div>
                  </div>
