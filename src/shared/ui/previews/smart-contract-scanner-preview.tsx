...
const MOCK_RESULTS: Record<
  string,
  {
    ...
    label: string;
    color: string;
    checks: { name: string; desc: string; status: "safe" | "warning" }[];
  }
> = {
  "0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48": {
    ...
    checks: [
      ...
      },
      {
        ...
        desc: "Direct implementation, no upgradeable proxy",
        status: "safe",
      },
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 10,
                border: "none",
                background: address.trim() ? "var(--w3-accent)" : "var(--w3-gray-300)",
                color: "#fff",
                fontSize: 13,
                fontWeight: 600,
        ...
        <>
          ...
          <div style={{ padding: "20px", display: "flex", alignItems: "center", gap: 20 }}>
            ...
            >
              ...
              <span style={{ fontSize: 11, fontWeight: 500, color: result.color, marginTop: 6 }}>
                {result.label}
              </span>
            </div>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                  ...
                  <span style={{ fontSize: 13, color: "var(--w3-gray-600)" }}>
                    {result.checks.filter((c) => c.status === "safe").length} passed
                  </span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 4 }}>
                  <div
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: 28,
                        borderRadius: 8,
                        background: isSafe ? "rgba(34,197,94,0.1)" : "rgba(245,158,11,0.1)",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        flexShrink: 0,
