                ...
                {WALLETS.map((w) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        connect(w.id);
                        safeTimeout(() => setPickerOpen(false), 1500);
                      }}
                      disabled={isDisabled}
                      style={{
                        display: "flex",
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: "transparent",
                  cursor: "pointer",
                  color: copied ? "#22c55e" : "var(--w3-gray-600)",
                  display: "flex",
                }}
              >
            ...
            <div>
              ...
              >
                <span style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  <div
                    style={{ width: 10, height: 10, borderRadius: "50%", background: chain.color }}
                  />
                  {chain.name}
                </span>
                <ChevronDown
                  ...
                  {CHAIN_ENTRIES.map(([id, c]) => (
                    <button
                      ...
                      style={{
                        ...
                        border: "none",
                        background:
                          chainId === Number(id) ? "var(--w3-accent-subtle)" : "transparent",
                        cursor: "pointer",
                        fontSize: 14,
                        fontWeight: 500,
                        color: "var(--w3-gray-900)",
                    ...
                    >
                      ...
                      {chainId === Number(id) && (
                        <Check
                          size={14}
                          style={{ marginLeft: "auto", color: "var(--w3-accent)" }}
                        />
                      )}
                    </button>
                  ))}
      ...
      <div style={{ ...previewCard, maxWidth: 400, width: "100%" }}>
            ...
            <>
              ...
              <button
                ...
                style={{
                  ...
                  padding: "12px 14px",
                  borderRadius: 12,
                  border: "1.5px solid var(--w3-accent)",
              ...
              >
                ...
                <span
                  style={{ flex: 1, fontSize: 15, fontWeight: 500, color: "var(--w3-gray-900)" }}
                >
                  {recentWallet.name}
                </span>
            ...
            return (
              ...
              >
                ...
                {active ? (
                  ...
                  <span style={{ fontSize: 14, color: "var(--w3-gray-500)", flexShrink: 0 }}>
                    →
                  </span>
                )}
              </button>
        ...
        >
          <span style={{ fontSize: 13, color: "var(--w3-gray-500)" }}>
            {WALLETS.length} wallets supported
          </span>
        </div>
      </div>
    </div>
