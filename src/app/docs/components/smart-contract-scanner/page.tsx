            ...
            {activeTab === "preview" ? (
              <div className="p-4 bg-gray-50 dark:bg-gray-900">
                <SmartContractScanner
                  ...
                  onScan={(address) => console.log("Scanning contract:", address)}
                  onFunctionCall={(name, inputs) => console.log("Calling function:", name, inputs)}
                />
              </div>
            ) : (
              <CodeBlock
                code={`import { SmartContractScanner } from "@w3-kit/smart-contract-scanner";
