...
export default function LimitOrderManagerPage() {
  ...
  const handleOrderCreate = async (order: Omit<OrderData, "id" | "timestamp">) => {
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="rounded-lg overflow-hidden">
            {activeTab === "preview" ? (
              ...
              <CodeBlock
                code={`import { LimitOrderManager } from "@/components/ui/limit-order-manager"
              ...
              {installTab === "cli" ? (
                <>
                  ...
                  <ul className="list-disc pl-6 mb-4 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <li>Add order management utilities to your project</li>
                  </ul>
                </>
              ) : (
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <CodeBlock
                      code={`// components/ui/limit-order-manager/index.tsx
import { LimitOrderManager } from "@/components/ui/limit-order-manager/component"
