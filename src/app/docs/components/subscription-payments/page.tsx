...
import { SubscriptionPlan } from "@/components/w3-kit/subscription-payments-types";
            ...
            <div className="mt-4">
              {installTab === "cli" ? (
                <>
                  ...
                  <CodeBlock code="npx shadcn@latest add https://w3-kit.com/registry/subscription-payments.json" id="cli" />
